...
For a detailed breakdown of our worker scaling strategy, high-volume traffic handling (100k+ tasks/day), database indexing, and disaster recovery strategies, please refer to the architecture documentation:
👉 [ARCHITECTURE.md](./docs/ARCHITECTURE.md)

Our PRD compliance checklist is available here:
👉 [PRD_CHECKLIST.md](./PRD_CHECKLIST.md)
...
2. **Deploy the Infrastructure:**
   The companion infrastructure repository contains all `Deployment`, `Service`, `ConfigMap`, `Secret`, and `Ingress` manifests. Apply the Argo CD application definition to automatically sync the cluster:
   ```bash
   kubectl apply -f https://raw.githubusercontent.com/Vaibhav-Singh2/ai-task-platform-infra/main/argocd-app.yaml
   ```
