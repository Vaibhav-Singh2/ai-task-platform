...
export default function LoginPage() {
  return (
    <main className="grid min-h-screen bg-[var(--bg)] p-4 sm:p-8 lg:grid-cols-2 lg:p-12">
      <section className="relative hidden overflow-hidden rounded-3xl border border-[var(--line)] bg-[var(--surface)] p-12 lg:flex lg:flex-col lg:justify-between">
        <div>
          ...
          <h1 className="text-6xl font-black leading-[0.95] tracking-tight">
            Orchestrate <span className="text-[var(--primary)]">Intelligence</span>
          </h1>
